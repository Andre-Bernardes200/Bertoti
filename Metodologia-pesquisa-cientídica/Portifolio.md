...
## Contatos:
  <a href="https://www.linkedin.com/in/andre-oliveira2004/"><img src="https://img.shields.io/badge/linkedin-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white"></a> 
  <a href="mailto:andreluiz1088@hotmail.com"><img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white"></a>
  <a href="https://github.com/Andre-Bernardes200"><img src="https://img.shields.io/badge/github-0D1117.svg?style=for-the-badge&logo=github&logoColor=white"></a>
...
<h2>Minhas Contribuições</h2>
 ...
 > Contribuí ativamente no desenvovilmento back-end do projeto e, também, na criação do banco de dados, sua prototipagem, seu script e suas atualizações ao longo do projeto.

### 1. **Modelagem do banco de dados e armazenamento dos dados através de um arquivo CSV**
   - Contribui para a modelagem do banco de dados, garantindo sua normalização ao longo de todo o projeto e incorporando a leitura de arquivos CSV para facilitar a importação de dados, otimizando a eficiência nas operações de inserção dos dados e recuperação de informações.

### 2. **Conexão com o banco de dados**
   - Contribuí ativamente com o desenvolvimento da funcionalide de conexão com banco.

### 3. **Criação da funcionalidade de editar alunos**
  - Contribui para o desenvolvimento da funcionalidade de edição de alunos, permitindo a seleção de um aluno específico para atualizar suas informações. Após a edição, os novos dados são salvos no banco de dados, garantindo a atualização eficiente e precisa das informações.
    
### 4. **Tratamentos de erro**
  - Contribuí na implementação do tratamento de erros na aplicação, garantindo que, em caso de falhas, uma mensagem clara e informativa fosse exibida ao usuário.

### 5. **Build da aplicação**
  - Contribuí para a configuração da aplicação, garantindo a execução adequada de arquivos .jar, incluindo a definição correta do ambiente e das dependências necessárias para seu funcionamento pleno e eficiente.
<br>

<h2>Conhecimentos Obtidos</h2>
<p align="justify">Durante o desenvolvimento dessas funcionalidades, obtive conhecimentos em modelagem de banco de dados, garantindo normalização e integração de arquivos CSV para manipulação de dados. Aprimorei minhas habilidades em conexão com o banco, configurando drivers e strings de conexão, e em edição de registros, assegurando a atualização eficiente das informações.

Com o tratamento de erros, aprendi a prever falhas e exibir mensagens claras ao usuário, melhorando a experiência e a confiabilidade da aplicação. Na build da aplicação, adquiri experiência em empacotamento de arquivos .jar e configuração de ambientes, consolidando boas práticas para desenvolvimento e implantação.</p>
...
<h2>Minhas Contribuições</h2>
 ...
 > Contribuí ativamente como desenvolvedor back-end, desempenhando um papel importante na equipe mantendo o banco de dados e desenvolvendo 2 das 3 funcionalidades principais da aplicação.
